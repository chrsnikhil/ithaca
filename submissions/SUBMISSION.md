...
- **CCTP:** the Base **burn** is proven on Base; attestation + mint are implemented. A full round-trip Arc **mint** tx is not yet captured. We say "burn proven on Base; attestation + mint implemented," not "full round-trip proven."
